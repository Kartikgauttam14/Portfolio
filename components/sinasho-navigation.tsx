...
export function SinashoNavigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8 py-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* Center Navigation - exact pill shape */}
        ...
        <div className="hidden md:flex items-center space-x-3">
          <Link
            ...
            className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/20 transition-colors duration-200 border border-white/20"
          >
